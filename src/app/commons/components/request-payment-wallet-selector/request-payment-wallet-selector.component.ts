...
@Component({
	selector: 'request-payment-wallet-selector',
	templateUrl: './request-payment-wallet-selector.component.html',
	styleUrls: ['./request-payment-wallet-selector.component.css']
})
export class RequestPaymentWalletSelectorComponent implements OnInit {
